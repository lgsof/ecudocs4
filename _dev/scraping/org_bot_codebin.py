...
class CodebinBot:
	...
	#-- Load webdriver, with options, from browser driver
	def loadWebdriver ():
		options = Options()
	...
	def getValuesFromCodebinWeb (self, docNumber, pais, codigoPais):
		...
		self.locateOnSearchSite (urlSettings)
		docForm       = self.searchDocumentInSite (urlSettings, docNumber)
		codebinValues = self.getVauesFromForm (docForm, codigoPais, docNumber)
	...
	#-------------------------------------------------------------------
	def locateOnSearchSite (self, urlSettings):
	...
	def initWebdriver (self):
		try:
			...
			print (f"+++ CODEBIN...WEBDRIVER: {CodebinBot.webdriver}")
	...
	#------------------------ DEPRECATED ----------------------------
	#------------------------ DEPRECATED ----------------------------
	def old_openLoginCodebin (self, pais):
		try:
