...
from app_usuarios.admin_mixins import EmpresaFilterAdminMixin # For Multi-tenant
...
class ClienteAdmin (EmpresaFilterAdminMixin, admin.ModelAdmin):
	list_display =	('nombre', 'id', 'direccion', 'ciudad', 'pais')

# Register the admin class with the associated model
admin.site.register (Cliente, ClienteAdmin)

class ConductorAdmin (EmpresaFilterAdminMixin, admin.ModelAdmin):
