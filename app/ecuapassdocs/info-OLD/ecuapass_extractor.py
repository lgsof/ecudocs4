...
class Extractor:
	...
	def removeSubjectId (text, subject, type):
		...
		newText = DocUtils.removeEmptyLinesFromText (text)
	...
	def removeSubjectCiudadPais (text, subject, resourcesPath, type):
		...
		try:
			...
			if matchPais:
				...
				text = DocUtils.removeSpanishAccents (text) # Search for the country
	...
	def removeSubjectNombreDireccion (text, subject, type):
		...
		print (f"\t+++ SubjectInfo for Nombre-Dir: Removed NombreDireccion '{subject}'\n'{text}'")
		return (text, subject)
